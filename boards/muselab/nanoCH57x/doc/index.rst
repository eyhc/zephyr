...
The `QingKe V3C 32-bit RISC-V processor`_ of the nanoCH57x is running at up to
...
board. These mappings can be configured through DTS. The following figure
shows the possible routings for each peripheral.

.. figure:: img/nanoCH57x_pin_mapping.webp
   :align: center
   :alt: nanoCH57x pin mapping

   nanoCH57x pin mapping (default and possible remappings)
...
:zephyr_file:`boards/muselab/nanoCH57x/nanoCH57x_ch570.dts`.
